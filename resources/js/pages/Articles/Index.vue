...
import type { Article, Tag, PaginatedArticles, CategoryArticles } from '@/types';
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    ...
                    <nav class="hidden items-center gap-6 md:flex">
                        ...
                        <Link href="/?tag=gang-violence" class="text-sm text-zinc-300 hover:text-white">Gang Violence</Link>
                        <Link href="/?tag=organized-crime" class="text-sm text-zinc-300 hover:text-white">Organized Crime</Link>
                        <Link href="/?tag=drug-crime" class="text-sm text-zinc-300 hover:text-white">Drug Crime</Link>
                    </nav>
                ...
                <div v-if="showMobileMenu" class="border-t border-zinc-800 py-4 md:hidden">
                    ...
                    <nav class="flex flex-col gap-2">
                        ...
                        <Link href="/?tag=gang-violence" class="rounded px-3 py-2 text-sm text-zinc-300 hover:bg-zinc-800 hover:text-white">Gang Violence</Link>
                        <Link href="/?tag=organized-crime" class="rounded px-3 py-2 text-sm text-zinc-300 hover:bg-zinc-800 hover:text-white">Organized Crime</Link>
                        <Link href="/?tag=drug-crime" class="rounded px-3 py-2 text-sm text-zinc-300 hover:bg-zinc-800 hover:text-white">Drug Crime</Link>
                    </nav>
                </div>
            </div>
        </header>
